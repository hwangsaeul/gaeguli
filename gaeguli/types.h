...
typedef enum {
  GAEGULI_TARGET_TYPE_UNKNOWN,
  GAEGULI_TARGET_TYPE_SRT,
  GAEGULI_TARGET_TYPE_RECORDING,
  GAEGULI_TARGET_TYPE_IMAGE_CAPTURE
} GaeguliTargetType;
...
typedef enum {
  GAEGULI_SOURCE_PROVIDER_MSG_UNKNOWN = 0,
  GAEGULI_SOURCE_PROVIDER_MSG_CREATE_PIPELINE,
  GAEGULI_SOURCE_PROVIDER_MSG_DESTROY_PIPELINE
} GaeguliSourceProviderMsgType;

typedef enum {
  GAEGULI_SOURCE_PROVIDER_RSP_UNKNOWN = 0,
  GAEGULI_SOURCE_PROVIDER_RSP_CREATE_SUCCESS,
  GAEGULI_SOURCE_PROVIDER_RSP_DESTROY_SUCCESS,
  GAEGULI_SOURCE_PROVIDER_RSP_FAIL
} GaeguliSourceProviderRspType;

typedef enum {
  GAEGULI_CONSUMER_MSG_UNKNOWN = 0,
  GAEGULI_CONSUMER_MSG_CREATE_SRT_TARGET = GAEGULI_TARGET_TYPE_SRT,
  GAEGULI_CONSUMER_MSG_CREATE_RECORDING_TARGET = GAEGULI_TARGET_TYPE_RECORDING,
  GAEGULI_CONSUMER_MSG_CREATE_IMGCAPTURE_TARGET = GAEGULI_TARGET_TYPE_IMAGE_CAPTURE,
  GAEGULI_CONSUMER_MSG_START_TARGET,
  GAEGULI_CONSUMER_MSG_DESTROY_TARGET
} GaeguliConsumerMsgType;

typedef enum {
  GAEGULI_CONSUMER_RSP_UNKNOWN = 0,
  GAEGULI_CONSUMER_RSP_CREATE_TARGET_SUCCESS,
  GAEGULI_CONSUMER_RSP_START_TARGET_SUCCESS,
  GAEGULI_CONSUMER_RSP_DESTROY_TARGET_SUCCESS,
  GAEGULI_CONSUMER_RSP_FAIL

...
#define GAEGULI_PIPELINE_WORKER_ARGS_NUM  13
#define GAEGULI_TARGET_WORKER_ARGS_NUM 20

typedef enum {
  GAEGULI_UNKOWN_PIPELINE_MSG = 0,
  GAEGULI_SET_FPS_MSG = 1,
  GAEGULI_SET_RESOLUTION_MSG = 2,
  GAEGULI_SET_OVERLAY_MSG = 3,
  GAEGULI_PIPELINE_TERMINATE_WORKER_MSG = 4,
} GaeguliPipelineMsgType;

typedef enum {
  GAEGULI_UNKOWN_TARGET_MSG = 0,
  GAEGULI_SET_TARGET_START_MSG = 1,
  GAEGULI_SET_TARGET_STOP_MSG = 2,
  GAEGULI_SET_TARGET_BITRATE_MSG = 3,
  GAEGULI_SET_TARGET_BITRATE_CONTROL_MSG = 4,
  GAEGULI_SET_TARGET_QUANTIZER_MSG = 5,
  GAEGULI_SET_TARGET_ADAPTOR_TYPE_MSG = 6,
  GAEGULI_SET_TARGET_ADAPTIVE_STREAMING_MSG = 7,
} GaeguliTargetMsgType;

typedef enum {
  GAEGULI_UNKOWN_TARGET_WORKER_MSG = 0,
  GAEGULI_TARGET_PIPELINE_STARTED_MSG = 1,
  GAEGULI_TARGET_PIPELINE_STOPPED_MSG = 2,
  GAEGULI_TARGET_SRT_MODE_MSG = 3,
  GAEGULI_TARGET_CALLER_ADDED_MSG = 4,
  GAEGULI_TARGET_CALLER_REMOVED_MSG = 5,
  GAEGULI_TARGET_NOTIFY_ENCODER_BITRATE_CONTROL_CHANGE_MSG = 6,
  GAEGULI_TARGET_NOTIFY_ENCODER_BITRATE_CHANGE_MSG = 7,
  GAEGULI_TARGET_NOTIFY_ENCODER_QUANTIZER_CHANGE_MSG = 8,
} GaeguliTargetWorkerMsgType;
